...
// $abc = ['A', 'B', 'C'];
// $mysqliResult1 = mysql_query('SELECT * FROM spr_site_services limit 0');
// $mysqliResult2 = mysql_query('SELECT id FROM spr_site_services limit 1');
// $mysqliResult3 = mysql_query('SELECT id FROM spr_site_services');
// $mysqliResult4 = mysql_query('SELECT * FROM spr_site_services limit 1');
// $mysqliResult5 = mysql_query('SELECT * FROM spr_site_services');
// $stdClass1 = (object) [];
...
// VarDumper::dump($mysqliResult1, 'mysqliResult1');
// VarDumper::dump($mysqliResult2, 'mysqliResult2');
// VarDumper::dump($mysqliResult3, 'mysqliResult3');
// VarDumper::dump($mysqliResult4, 'mysqliResult4');
// VarDumper::dump($mysqliResult5, 'mysqliResult5');
...
// VarDumper::dump(MySqlQuery::findById('spr_site_services', 1), 'findById2');
...
// VarDumper::dump(MySqlQuery::getScalar('SELECT id FROM spr_site_services LIMIT 0'), 'getScalar1');
// VarDumper::dump(MySqlQuery::getScalar('SELECT id FROM spr_site_services LIMIT 1'), 'getScalar2');
...
// VarDumper::dump(MySqlQuery::select('SELECT * FROM spr_site_services'), 'select');
?>
<form method="post">
	<?php echo getHtmlControl('name') ?>
